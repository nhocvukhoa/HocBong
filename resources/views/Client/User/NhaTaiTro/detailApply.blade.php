    ...
    <div class="container">
        ...
        <div class="card shadow mb-4" style="margin-top: 20px;">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-center">Hồ sơ đăng kí</h6>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-bordered" id="loaihocbong_table" width="100%" cellspacing="0">
                        <div class="d-flex justify-content-start align-items-center mb-3">
                            ...
                            <div class="add-note d-flex flex-column">
                                <label for="" class="mb-2">* Ghi chú hồ sơ</label>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{asset('public/Upload/ThongBao/'.$detail->hoso_hinhanh)}}" target="_blank">
                                        Xem file
                                    </a>
                                    @else
