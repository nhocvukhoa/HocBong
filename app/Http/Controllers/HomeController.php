...
{  
    ...
    public function index(Request $request) {
       ...
       // $user_total = User::orderBy('id', 'asc')->count();
        ...
        $hocbong_dangky = DangKyHocBong::select(
            'hocbong.hocbong_id','hocbong.hocbong_ten', 'hocbong_hinhanh', 'hocbong.hocbong_thoigianketthuc',
        ...
        ->groupBy('dangkyhocbong.dangky_ketqua')
        ->limit(4)
        ->get();
      
        return view('Client.Home.showHocBong', compact('title','loaihocbong', 'hocky', 'nhataitro', 
        'listhocbong', 'hocbong_luotxem', 'hocbong_dangky'));
    }
    ...
    public function searchHocBong(Request $request) {
        ...
        $hocbong_dangky = DangKyHocBong::select(
            ...
            'hocbong.hocbong_ten',
            'hocbong_hinhanh',
            'hocbong.hocbong_thoigianketthuc',
            DB::raw('COUNT(dangkyhocbong.hocbong_id) AS total_apply'),
        )
            ->join('hocbong', 'hocbong.hocbong_id', '=', 'dangkyhocbong.hocbong_id')
            ->groupBy('dangkyhocbong.hocbong_id')
        ...
        'hocbong_luotxem', 'hocbong_dangky'));
    }
    ...
    public function detailThongBao($thongbao_id) {
     ...
     public function filterHocBong(Request $request) {
         ...
         $get_all_hocbong = HocBong::whereBetween('hocbong_thoigiandang', [$start, $end])->orderBy('hocbong_id','desc')
         ->paginate(9);
         DB::statement("SET SQL_MODE=''");
         $hocbong_luotxem = HocBong::orderBy('hocbong_luotxem', 'desc')->limit(4)->get();
         $hocbong_dangky = DangKyHocBong::select(
